<!-- Submits the information to the data base and send an email -->
...
<?php
	...
	try {
        ...
        $statement = null;
        if($is_ra == "false") {
    		$statement = $pdo->prepare("INSERT IGNORE INTO $table (first_name, last_name, email_student, stu_id, major, advisor, ademail, atype, year, quarter, hdept, cid1, ctitle1, credit1, cid2, ctitle2, credit2, cid3, ctitle3, credit3, cid4, ctitle4, credit4, cid5, ctitle5, credit5, cid6, ctitle6, credit6, total, stusign, studate) VALUES (:fname, :lname, :email_student, :stu_id, :major, :advisor, :ademail, :atype, :year, :quarter, :hdept, :cid1, :ctitle1, :credit1, :cid2, :ctitle2, :credit2, :cid3, :ctitle3, :credit3, :cid4, :ctitle4, :credit4, :cid5, :ctitle5, :credit5, :cid6, :ctitle6, :credit6, :total, :stusign, :studate)");
        }
        else {
            $statement = $pdo->prepare("INSERT IGNORE INTO $table (first_name, last_name, email_student, stu_id, major, advisor, ademail, atype, year, quarter, hdept, ra_acc, ra_fund, ra_dept, ra_pgm, ra_act, ra_class, ra_id, cid1, ctitle1, credit1, cid2, ctitle2, credit2, cid3, ctitle3, credit3, cid4, ctitle4, credit4, cid5, ctitle5, credit5, cid6, ctitle6, credit6, total, stusign, studate) VALUES (:fname, :lname, :email_student, :stu_id, :major, :advisor, :ademail, :atype, :year, :quarter, :hdept, :ra_acc, :ra_fund, :ra_dept, :ra_pgm, :ra_act, :ra_class, :ra_id, :cid1, :ctitle1, :credit1, :cid2, :ctitle2, :credit2, :cid3, :ctitle3, :credit3, :cid4, :ctitle4, :credit4, :cid5, :ctitle5, :credit5, :cid6, :ctitle6, :credit6, :total, :stusign, :studate)");
